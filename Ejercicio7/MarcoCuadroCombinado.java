...
public class MarcoCuadroCombinado extends JFrame {
    ...
    private static final String nombres[] = { "insecto(1).gif", "insecto(2).gif", "insecto(3).gif", "insecto(4).gif" };
    private final Icon[] iconos = {
        new ImageIcon(getClass().getResource("insecto(1).gif")),
        new ImageIcon(getClass().getResource("insecto(2).gif")),
        new ImageIcon(getClass().getResource("insecto(3).gif")),
        new ImageIcon(getClass().getResource("insecto(4).gif"))};
